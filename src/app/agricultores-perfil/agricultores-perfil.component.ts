...
@Component({
  selector: 'app-agricultores-perfil',
  standalone: true,
  imports: [
    FormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './agricultores-perfil.component.html',
  styleUrls: ['./agricultores-perfil.component.css']
})
export class AgricultoresPerfilComponent implements OnInit {
