...
@Component({
  selector: 'app-creaeditarsolicitud',
  standalone: true,
  ...
  templateUrl: './creaeditarsolicitud.component.html',
  styleUrl: './creaeditarsolicitud.component.css'
})
export class CreaeditarsolicitudComponent implements OnInit{
