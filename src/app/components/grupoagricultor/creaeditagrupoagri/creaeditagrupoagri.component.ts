...
@Component({
  selector: 'app-creaeditagrupoagri',
  standalone: true,
  ...
  templateUrl: './creaeditagrupoagri.component.html',
  styleUrl: './creaeditagrupoagri.component.css'
})
export class CreaeditagrupoagriComponent implements OnInit {
...
myFilter = (d: Date | null): boolean => {
  ...
  aceptar(): void {
    if (this.form.valid) {
      ...
      this.router.navigate(['grupoagricultor']);
    }
  }
